      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8 md:p-12 animate-fade-in">
          ...
          <div className="prose prose-blue max-w-none text-gray-600 space-y-6">
            <p className="text-lg">
              Bem-vindo à <strong>MDigital Marketing & Consultoria</strong>. Ao acessar este site e utilizar nossos serviços, você concorda em cumprir e estar vinculado aos seguintes termos e condições de uso.
            </p>
            ...
            <section>
              ...
              <p>
                A MDigital oferece serviços de marketing digital, gestão de tráfego pago, consultoria de vendas e presença em redes sociais. O escopo específico de cada serviço será detalhado em contrato individualizado para cada cliente.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Todo o conteúdo deste site (textos, design, logotipos, ícones) é de propriedade exclusiva da MDigital ou de seus licenciadores e está protegido pelas leis de direitos autorais brasileiras e internacionais. A reprodução não autorizada é proibida.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Embora trabalhemos para garantir os melhores resultados, o marketing digital depende de variáveis de mercado e comportamentais externas. A MDigital não garante lucros específicos, mas compromete-se com a execução técnica de excelência das estratégias acordadas.
              </p>
            </section>
