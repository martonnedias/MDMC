...
const AboutPage: React.FC = () => {
  ...
  return (
    <div className="pt-24 bg-white font-sans">
      {/* Manifesto Hero */}
      <section className="py-20 lg:py-32 bg-brand-darkBlue text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
           <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                 ...
                 <Button onClick={() => window.open('https://wa.me/5511999999999?text=Olá! Gostaria de falar sobre a consultoria MDigital.')} variant="outline" className="px-12 py-5 text-lg">
                    Falar no WhatsApp
                 </Button>
              </div>
           </div>
