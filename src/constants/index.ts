...
export const SERVICES_CONTENT = {
  title: "Nossa Jornada de <span class='text-brand-gold'>Escala Digital</span>",
  ...
  items: [
    {
      ...
      icon: Target,
      color: "bg-yellow-100 text-brand-gold",
      icon_bg: "bg-yellow-500 text-white"
    },
    {
    ...
    },
    {
      ...
      icon: Share2,
      color: "bg-brand-goldLight text-brand-gold",
      icon_bg: "bg-brand-gold text-white"
    },
    {
      title: "Gestão de CRM",
...
export const SOCIAL_MEDIA_CONTENT = {
  hero: {
    title: "Sua marca com <span class='text-brand-gold italic'>Alma e Estratégia</span>",
...
export const SITES_CONTENT = {
  ...
  problems: [
    ...
    { title: "Mobile First", text: "Mais de 80% do tráfego vem do celular. Seu site precisa ser perfeito nele.", icon: Smartphone, color: "text-brand-gold bg-yellow-100" },
...
export const ADS_CONTENT = {
  comparison: {
    title: "Amador vs. <span class='text-brand-gold italic pr-1'>Profissional</span>",
