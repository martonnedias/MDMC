        ...
        <div className="fixed bottom-0 left-0 w-full z-[100] p-4 md:p-6 animate-fade-in">
            <div className="container mx-auto max-w-5xl">
                <div className="bg-[#0A1931]/90 backdrop-blur-xl border border-white/10 rounded-[2rem] p-6 shadow-[0_20px_50px_rgba(0,0,0,0.3)] flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden relative group">
                    {/* Luz de fundo sutil */}
                    <div className="absolute -top-24 -left-24 w-48 h-48 bg-brand-gold/10 rounded-full blur-[80px] pointer-events-none group-hover:bg-brand-gold/20 transition-all duration-700"></div>
                    ...
                    <div className="flex items-center gap-5 relative z-10">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <p className="text-gray-400 text-sm leading-relaxed max-w-xl">
                                Utilizamos cookies para melhorar sua experiência e analisar nosso tráfego. Ao clicar em "Aceitar", você concorda com nosso uso de cookies de acordo com nossa <button onClick={() => window.open('/privacy', '_blank')} className="text-brand-gold hover:underline font-bold">Política de Privacidade</button>.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 relative z-10 shrink-0">
                        ...
                        <Button
                            ...
                            variant="primary"
                            className="py-4 px-8 text-sm font-black uppercase tracking-widest shadow-xl shadow-brand-gold/20"
                        >
                            Aceitar Cookies
                        </Button>
