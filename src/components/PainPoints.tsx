      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="max-w-7xl mx-auto">
              ...
              return (
                <div key={index} className="group flex flex-col gap-8 p-10 rounded-[2.5rem] bg-white border border-slate-100 hover:shadow-[0_40px_80px_-15px_rgba(0,0,0,0.08)] transition-all duration-700 relative overflow-hidden hover:scale-[1.02]">
                  ...
                  <div className="relative z-10">
                    <div className="w-14 h-14 rounded-2xl bg-slate-50 flex items-center justify-center text-brand-darkBlue group-hover:bg-brand-gold group-hover:text-white transition-all duration-500 shadow-sm">
                      <Icon size={28} />
                    </div>
                  </div>
          ...
          <div className="relative max-w-5xl mx-auto">
            <div className="absolute -inset-1 bg-gradient-to-r from-brand-blue to-brand-gold rounded-[3rem] blur opacity-20 animate-pulse"></div>
            <div className="relative text-center bg-brand-darkBlue p-12 lg:p-20 rounded-[3rem] border border-white/5 overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 w-64 h-64 bg-brand-gold/5 rounded-full blur-[100px] -ml-32 -mb-32"></div>

              <div className="inline-flex items-center gap-2 mb-8 px-4 py-1 rounded-full bg-white/5 border border-white/10 text-brand-gold text-[10px] font-black uppercase tracking-widest">
              ...
              <p className="text-3xl md:text-4xl lg:text-5xl font-heading font-black text-white leading-[1.1] tracking-tighter max-w-4xl mx-auto mb-10">
                {PAIN_CONTENT.transition.split('Performance Digital').map((part, i, arr) => (
                  <React.Fragment key={i}>
                    {part}
                    {i < arr.length - 1 && <span className="text-brand-gold">Performance Digital</span>}
                  </React.Fragment>
                ))}
              </p>

              <button className="h-14 px-10 bg-white text-brand-darkBlue font-black uppercase text-[10px] tracking-widest rounded-full hover:bg-brand-gold hover:text-white transition-all shadow-xl">
