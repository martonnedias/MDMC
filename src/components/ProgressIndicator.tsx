        ...
        <div className="mb-12 space-y-8">
            ...
            <div className="relative pt-6 pb-2">
                ...
                <div className="h-2 bg-gray-100 rounded-full shadow-inner relative">
                    {/* Fill Gradient */}
                    <div
                        className="h-full bg-gradient-to-r from-brand-blue to-brand-gold transition-all duration-700 ease-out rounded-full relative"
                            ...
                            return (
                                <button
                                    ...
                                    ${isPast ? 'bg-brand-blue border-brand-blue scale-100' :
                                            isCurrent ? 'bg-white border-brand-gold scale-125 shadow-md z-10' :
                                                'bg-white border-gray-200'}
                                    ${isSelectable ? 'cursor-pointer hover:border-brand-gold hover:scale-150' : 'cursor-default'}
                                `}
                                >
                                    {/* Tooltip */}
                ...
                {/* Percentage Badge */}
                <div
                    className="absolute top-0 bg-brand-gold text-white px-2 py-0.5 rounded-full text-[9px] font-black shadow-lg transition-all duration-700 ease-out z-20"
