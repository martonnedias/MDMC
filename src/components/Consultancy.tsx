        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="bg-white/10 p-6 rounded-xl border border-white/20 backdrop-blur-sm mb-8">
                <p className="font-heading font-bold text-xl mb-2 text-brand-gold">Investimento</p>
          ...
          <div className="lg:w-1/2 bg-white rounded-2xl p-8 text-gray-900 shadow-2xl w-full">
            ...
            <div className="mt-8 p-4 bg-brand-gold/10 rounded-lg border border-brand-gold/20">
              <p className="text-brand-goldHover font-semibold text-center text-sm">
