            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                ...
                <div className="space-y-8">
                    <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    const newSlug = !service.slug
                                        ? newName.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)+/g, '')
                                        : service.slug;
                                    setService({ ...service, name: newName, slug: newSlug });
                                }}
                        ...
                        <div>
                            <label className={labelStyles}>Slug (URL Amigável)</label>
                            <input
                                type="text"
                                value={service.slug || ''}
                                ...
                                placeholder="Ex: md-ads-premium"
                            />
                            <p className="text-[10px] text-gray-400 mt-2 font-bold italic">Opcional. Usado para acessar a página dedicada deste serviço: /servicos/[slug]</p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label htmlFor="service-category" className={labelStyles}>Categoria de Mercado</label>
                                <select
                                    id="service-category"
                                    title="Categoria de Mercado"
                            ...
                            <div>
                                <label htmlFor="display-order" className={labelStyles}>Ordem de Destaque (Menor primeiro)</label>
                                <input
                                    id="display-order"
                                    type="number"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-6 border-b border-gray-50 mb-6">
                            <div>
                                <label htmlFor="service-page" className={labelStyles}>Página de Exibição</label>
                                <select
                                    id="service-page"
                            ...
                            <div>
                                <label htmlFor="section-id" className={labelStyles}>Bloco / Seção Interna</label>
                                <select
                                    id="section-id"
                                    title="Bloco / Seção Interna"
                    ...
                    <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-6">
                        <h3 className="font-black text-gray-900 flex items-center gap-2 border-b border-gray-50 pb-5 mb-5 uppercase tracking-tighter">
                            <Layout size={18} className="text-yellow-500" /> Gatilhos e Estilo
                        </h3>
                        ...
                        <div className="p-6 bg-yellow-50/30 rounded-3xl border border-yellow-100">
                            <label className="flex items-center gap-4 cursor-pointer group">
                                <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all ${service.is_highlighted ? 'bg-yellow-500 text-white shadow-lg' : 'bg-white text-gray-300 border border-gray-100'}`}>
