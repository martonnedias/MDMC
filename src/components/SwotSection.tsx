...
const SwotSection: React.FC<SwotSectionProps> = ({ onNavigate }) => {
  ...
  return (
    <section id="swot" className="py-12 lg:py-24 relative overflow-hidden" >
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20 max-w-5xl mx-auto">
          ...
          <div className="bg-yellow-50 p-8 rounded-[2rem] border border-yellow-100 flex flex-col h-full shadow-sm hover:shadow-md transition-shadow">
            <div className="w-12 h-12 bg-brand-gold text-white rounded-xl flex items-center justify-center mb-6">
              <ShieldCheck size={24} />
            </div>
            ...
            <Button onClick={() => onNavigate('swot-service')} variant="secondary" fullWidth className="border-brand-gold text-brand-gold hover:bg-brand-gold/5">Ver Planos de Auditoria</Button>
          </div>
        </div>
