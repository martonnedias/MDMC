        ...
        <div className="bg-white min-h-screen">
            ...
            <section className="pt-44 lg:pt-60 pb-16 px-6 text-center bg-slate-50 border-b border-slate-200">
                <div className="max-w-4xl mx-auto">
                    <span className="px-4 py-1.5 rounded-full bg-brand-gold/10 text-brand-gold text-[10px] font-black uppercase tracking-widest mb-6 inline-block border border-brand-gold/20">
                    ...
                    <h1 className="text-5xl md:text-7xl font-heading font-black text-brand-darkBlue mb-8 tracking-tighter">
                        Modelos de <br /><span className="text-brand-gold italic">Alta Performance</span>
                    </h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4 h-auto md:h-[600px]">
                        ...
                        <div className="md:col-span-2 md:row-span-2 bg-brand-darkBlue rounded-[2.5rem] p-12 text-white relative overflow-hidden group shadow-2xl">
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-between">
                                ...
                                <Button variant="primary" className="w-fit h-14 px-8 text-xs font-black uppercase tracking-widest bg-brand-gold border-none shadow-xl shadow-brand-gold/20">
                                    Explorar Estratégia
                                </Button>
                            </div>
                        </div>
                        ...
                        {/* Small Card Left */}
                        <div className="bg-brand-gold text-white rounded-[2.5rem] p-8 flex flex-col justify-center items-center text-center group hover:scale-[1.02] transition-transform duration-500 shadow-xl shadow-brand-gold/10">
            ...
            <section className="py-32 px-6 bg-slate-50 relative overflow-hidden border-y border-slate-200">
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
                    <div className="flex-1 lg:max-w-xl">
                        <span className="text-brand-gold font-black text-[11px] uppercase tracking-[0.5em] mb-8 block">
                    ...
                    <div className="flex-1 relative group">
                        ...
                        <div className="rounded-[4rem] overflow-hidden border-[16px] border-white shadow-3xl bg-white aspect-[4/5] relative">
                            ...
                            <div className="absolute inset-x-8 bottom-8 bg-brand-darkBlue/90 backdrop-blur-md p-8 rounded-3xl text-white">
                                <p className="text-xs font-black uppercase tracking-widest text-brand-gold mb-2">Padrão Ouro</p>
            ...
            <section className="py-24 px-6 bg-brand-darkBlue relative overflow-hidden">
                ...
                <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-brand-gold/10 rounded-full blur-[120px] animate-pulse delay-1000"></div>

                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    <div className="mb-20">
                        <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full glass-cyber text-brand-gold border border-white/10 text-[10px] font-black uppercase tracking-widest mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            { icon: MousePointer2, title: "UX Otimizada", desc: "Cada clique é uma decisão estratégica desenhada pela nossa equipe.", color: "gold" },
                            ...
                            <div key={i} className="glass-cyber rounded-[2.5rem] p-10 border border-white/5 hover:border-white/20 transition-all duration-700 bg-white/5 backdrop-blur-xl group hover:-translate-y-4">
                                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-8 mx-auto shadow-2xl ${item.color === 'gold' ? 'bg-brand-gold/20 text-brand-gold border border-brand-gold/30' : 'bg-brand-blue/20 text-brand-blue border border-brand-blue/30'}`}>
                                    <item.icon size={28} />
                                </div>
            ...
            <section className="py-24 px-6 bg-black relative overflow-hidden font-mono">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="mb-16">
                        <span className="text-blue-400 font-bold text-xs uppercase tracking-[0.3em] mb-4 block">
                        ...
                        <h2 className="text-4xl md:text-6xl font-heading font-black text-white mb-6 uppercase tracking-tighter">
                            A <span className="text-blue-400 font-mono">Maquinaria</span> por trás das vendas
                        </h2>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-slate-900/50 border border-blue-500/20 p-8 rounded-none relative group hover:border-blue-500/50 transition-all">
                            ...
                            <pre className="text-blue-400/30 text-[10px] mb-6 overflow-hidden">
...
> status: ready_to_scale`}
                            ...
                            <div className="flex gap-4">
                                <div className="px-3 py-1 bg-blue-500/10 border border-blue-500/30 text-blue-400 text-[10px] font-bold">STABLE</div>
            ...
            <section className="py-24 px-6 bg-brand-gold relative overflow-hidden">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="bg-white border-4 border-black p-10 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] transition-all transform hover:-translate-x-1 hover:-translate-y-1">
                            ...
                            <button className="w-full bg-brand-gold text-black border-4 border-black py-6 text-xl font-black uppercase shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] active:shadow-none active:translate-x-1 active:translate-y-1 transition-all">
                                DOMINAR AGORA
                            </button>
                        </div>
                        <div className="grid grid-cols-2 gap-8">
            ...
            <section className="py-24 px-6 bg-slate-50">
                <div className="max-w-5xl mx-auto rounded-[3rem] overflow-hidden border border-slate-200 shadow-2xl relative group bg-white">
                    ...
                    <div className="p-12 lg:p-24 relative z-10 flex flex-col items-center text-center">
                        <Layout className="text-brand-gold mb-8" size={64} />
