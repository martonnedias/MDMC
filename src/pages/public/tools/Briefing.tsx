...
import MarketingReport from '@/src/components/MarketingReport';
              ...
              <div ref={sliderRef} className="flex transition-transform duration-500 ease-in-out" style={{ transform: `translateX(-${currentStep * 100}%)` }}>
                ...
                <div className={stepContentClass}>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div><label className={labelClass}>Tipo de Atendimento *</label><select required title="Tipo de Atendimento" value={formData.serviceType} onChange={e => updateField('serviceType', e.target.value)} className={getSelectClass('serviceType')}><option value="">Selecione...</option><option value="Presencial">Presencial</option><option value="Online">Online</option><option value="Ambos">Ambos</option></select></div>
                      <div><label className={labelClass}>Momento atual? *</label><select required title="Momento atual" value={formData.businessMoment} onChange={e => updateField('businessMoment', e.target.value)} className={getSelectClass('businessMoment')}><option value="">Selecione...</option><option value="Lancamento">Lançamento / Início</option><option value="Crescimento">Crescimento Acelerado</option><option value="Estavel">Estável / Manutenção</option><option value="Queda">Em queda de faturamento</option></select></div>
                    </div>
                  </div>
                </div>
                ...
                <div className={stepContentClass}>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div><label className={labelClass}>Parcelamento máximo?</label><select title="Parcelamento máximo" value={formData.maxInstallments} onChange={e => updateField('maxInstallments', e.target.value)} className={getSelectClass('maxInstallments')}><option value="não parcelo">Não parcelo</option><option value="até 3x">Até 3x</option><option value="até 10x">Até 10x</option><option value="mais de 12x">Mais de 12x</option></select></div>
                      <div><label className={labelClass}>Prazo de entrega/execução? *</label><select required title="Prazo de entrega" value={formData.deliveryTime} onChange={e => updateField('deliveryTime', e.target.value)} className={getSelectClass('deliveryTime')}><option value="">Selecione...</option><option value="imediato">Imediato</option><option value="1–3 dias">1–3 dias</option><option value="1 semana">1 semana</option><option value="mais de 1 mês">Mais de 1 mês</option></select></div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div><label className={labelClass}>Precisa de agendamento? *</label><select required title="Necessidade de agendamento" value={formData.needsBooking} onChange={e => updateField('needsBooking', e.target.value)} className={getSelectClass('needsBooking')}><option value="">Selecione...</option><option value="sim">Sim, sempre</option><option value="preferencial">Preferencialmente</option><option value="não">Não precisa</option></select></div>
                      <div><label className={labelClass}>Oferece Garantia? *</label><select required title="Oferece Garantia" value={formData.hasWarranty} onChange={e => updateField('hasWarranty', e.target.value)} className={getSelectClass('hasWarranty')}><option value="sim">Sim</option><option value="não">Não</option></select></div>
                    </div>
                ...
                <div className={stepContentClass}>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div><label className={labelClass}>Poder aquisitivo médio? *</label><select required title="Poder aquisitivo médio" value={formData.incomeLevel} onChange={e => updateField('incomeLevel', e.target.value)} className={getSelectClass('incomeLevel')}><option value="">Selecione...</option><option value="Popular">Popular / Acessível</option><option value="Classe Média">Classe Média</option><option value="Alta Renda">Alta Renda / Luxo</option></select></div>
                    </div>
                    <div><label className={labelClass}>Como as pessoas mais chegam hoje? (Indicação, Insta, Google...)</label><input title="Canais de Chegada" placeholder="Ex: Indicação, Instagram" value={formData.leadSources} onChange={e => updateField('leadSources', e.target.value)} className={getInputClass('leadSources')} /></div>
                ...
                <div className={stepContentClass}>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div><label className={labelClass}>Já investe em anúncios? *</label><select required title="Investe em anúncios?" value={formData.hasAds} onChange={e => updateField('hasAds', e.target.value)} className={getSelectClass('hasAds')}><option value="">Selecione...</option><option value="Sim">Sim</option><option value="Sim, mas parou">Parei de investir</option><option value="Não">Nunca investi</option></select></div>
                      <div><label className={labelClass}>Tem Google Meu Negócio? *</label><select required title="Tem Google Meu Negócio" value={formData.hasGMB} onChange={e => updateField('hasGMB', e.target.value)} className={getSelectClass('hasGMB')}><option value="">Selecione...</option><option value="Sim">Sim</option><option value="Não">Não</option></select></div>
                    </div>
                ...
                <div className={stepContentClass}>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div><label className={labelClass}>Nota 0–10 p/ o seu Atendimento atual *</label><input type="number" min="0" max="10" required title="Nota de Atendimento" value={formData.serviceRating} onChange={e => updateField('serviceRating', e.target.value)} className={getInputClass('serviceRating')} /></div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div><label className={labelClass}>Seu time já fez treinamento de vendas? *</label><select required title="Treinamento de vendas" value={formData.hasSalesTraining} onChange={e => updateField('hasSalesTraining', e.target.value)} className={getSelectClass('hasSalesTraining')}><option value="Sim">Sim</option><option value="Não">Não</option></select></div>
                      <div><label className={labelClass}>Sente que um treinamento ajudaria? *</label><select required title="Gostaria de treinamento?" value={formData.wouldTrainingHelp} onChange={e => updateField('wouldTrainingHelp', e.target.value)} className={getSelectClass('wouldTrainingHelp')}><option value="Sim">Sim, com certeza</option><option value="Não">Não, meu time já é ótimo</option></select></div>
                    </div>
                  </div>
                </div>
                ...
                <div className={stepContentClass}>
                  ...
                  <div className="space-y-6">
                    ...
                    <div><label className={labelClass}>Quando pretende iniciar? *</label><select required title="Início pretendido" value={formData.startTime} onChange={e => updateField('startTime', e.target.value)} className={getSelectClass('startTime')}><option value="">Selecione...</option><option value="Imediato">Imediato</option><option value="15 dias">Em 15 dias</option><option value="30 dias">Próximo mês</option></select></div>
                  </div>
                </div>
                ...
                <div className={stepContentClass}>
                  ...
                  <div className="space-y-6">
                    ...
                    <div><label className={labelClass}>Algo importante que não perguntamos?</label><textarea title="Informações Adicionais" placeholder="Alguma observação extra?" value={formData.extraInfo} onChange={e => updateField('extraInfo', e.target.value)} className={getInputClass('extraInfo')} rows={2}></textarea></div>
                  </div>
                </div>
                ...
                <div className={stepContentClass}>
                  <div className="text-center py-16">
                    <div className="relative inline-block mb-10">
                      ...
                      <Rocket size={80} className="text-brand-gold relative z-10 animate-bounce" />
                    </div>
