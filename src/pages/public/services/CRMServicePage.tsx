        ...
        <div className="pt-0 pb-0">
            ...
            <section className="relative pt-44 lg:pt-60 pb-20 lg:pb-40 overflow-hidden bg-brand-darkBlue text-white">
                <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-40">
                    ...
                    <div className="absolute top-[20%] -right-[5%] w-[30%] h-[30%] bg-brand-gold/20 rounded-full blur-[100px]"></div>
                </div>

                <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
                    <div className="flex flex-col lg:flex-row items-center gap-20">
                        <div className="flex-[1.2]">
                            <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-md text-brand-gold px-4 py-1.5 rounded-full mb-8 font-black text-[9px] uppercase tracking-[0.2em] border border-white/10">
                            ...
                            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-heading font-black leading-[0.95] tracking-tighter mb-12"
                                dangerouslySetInnerHTML={{
                                    __html: section?.title || 'Pare de <span class="text-transparent bg-clip-text bg-gradient-to-r from-brand-gold to-yellow-400 italic pr-1">perder leads</span> por falta de organização.'
                                }}
                            />

                            <p className="text-xl lg:text-2xl text-blue-100/90 mb-12 leading-relaxed font-bold max-w-2xl border-l border-brand-gold/40 pl-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        <div className="text-white text-left order-1 lg:order-2">
                            <SectionTitle
                                ...
                                title={<>Assuma o <span className="text-brand-gold italic">controle</span> das suas vendas.</>}
