...
import { SOCIAL_MEDIA_PLANS } from '@/src/constants';
...
const SOCIAL_MEDIA_CONTENT = {
    ...
    mechanism: {
        title: "O Método <span class='text-brand-gold italic'>MD 360º</span>",
...
export default function SocialMediaServicePage() {
    ...
    return (
        <div className="bg-white min-h-screen font-sans selection:bg-brand-gold/20 selection:text-brand-darkBlue">
            ...
            <section className="relative pt-44 lg:pt-60 pb-20 lg:pb-32 overflow-hidden bg-slate-50">
                <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-brand-gold/5 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                        ...
                        <div className="flex-1 text-center lg:text-left">
                            ...
                            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-heading font-black text-brand-darkBlue tracking-tighter leading-[0.95] mb-12 max-w-4xl">
                                Sua marca não precisa de +1 post. <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-gold to-yellow-400 italic pr-1">Precisa de estratégia.</span>
                            </h1>

                            <p className="text-lg md:text-xl lg:text-2xl text-slate-700 mb-12 leading-relaxed font-bold max-w-2xl border-l-4 border-brand-gold/30 pl-8 transition-all">
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                                <Button
                                    ...
                                    className="h-16 px-10 text-base font-black uppercase tracking-widest bg-brand-gold hover:bg-yellow-500 text-brand-darkBlue shadow-xl shadow-brand-gold/20 hover:scale-105 transition-all duration-300 w-full sm:w-auto"
                                >
                            ...
                            <div className="relative rounded-[2rem] overflow-hidden shadow-2xl shadow-brand-darkBlue/20 border-8 border-white bg-slate-100 transform rotate-1 hover:rotate-0 transition-transform duration-700">
                                ...
                                <div className="absolute bottom-8 left-8 right-8 bg-white/90 backdrop-blur-md p-5 rounded-2xl border border-white/40 shadow-xl animate-float">
                                    ...
                                    <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                                        <div className="h-full bg-brand-gold w-[75%] rounded-full shadow-[0_0_10px_rgba(244,180,0,0.5)]"></div>
                                    </div>
                                </div>
                            </div>
            ...
            <section className="py-24 bg-white relative">
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-stretch">
                        ...
                        <div className="flex-1 bg-brand-darkBlue rounded-[2.5rem] p-8 lg:p-12 text-white relative shadow-2xl shadow-brand-darkBlue/20 transform lg:-translate-y-8 border-4 border-brand-gold/20 overflow-hidden group">
                            ...
                            <div className="absolute top-0 right-0 p-6 text-brand-gold opacity-20 group-hover:opacity-40 transition-opacity duration-700">
                                <CheckIcon size={120} />
                            </div>

                            <div className="relative z-10">
                                <div className="inline-block px-4 py-1.5 rounded-full bg-brand-gold/20 border border-brand-gold/40 text-brand-gold text-[10px] font-black uppercase tracking-widest mb-6">
                                    Experiência Premium
                                </div>
                                <h3 className="text-3xl font-heading font-black mb-10 flex items-center gap-3">
                                    <span className="w-12 h-12 rounded-xl bg-brand-gold flex items-center justify-center text-brand-darkBlue shadow-lg shadow-brand-gold/30">
                                        <CheckIcon size={24} />
                                    </span>
                                ...
                                <ul className="space-y-6">
                                    {SOCIAL_MEDIA_CONTENT.transformation.after.items.map((item, i) => (
                                        <li key={i} className="flex items-start gap-4 font-medium text-lg text-blue-50/90 group/item">
                                            <div className="w-6 h-6 rounded-full bg-brand-gold/20 flex items-center justify-center shrink-0 mt-0.5 border border-brand-gold/40 group-hover/item:bg-brand-gold group-hover/item:border-brand-gold transition-all">
                                                <CheckIcon size={12} className="text-brand-gold group-hover/item:text-brand-darkBlue transition-colors" />
                                            </div>
                                            {item}
                                        </li>
                                    ))}
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="text-center mb-16">
                        <SectionTitle
                            ...
                            title="O que você ganha com <span class='text-brand-gold italic'>MD Social</span>"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {SOCIAL_MEDIA_CONTENT.benefits.map((benefit, i) => (
                            <div key={i} className="group p-10 bg-slate-50 border border-slate-100 rounded-[2.5rem] hover:bg-white hover:shadow-[0_30px_60px_-12px_rgba(0,0,0,0.1)] transition-all duration-700 hover:scale-[1.02] hover:-translate-y-2">
                                <div className="w-14 h-14 bg-white shadow-lg rounded-2xl flex items-center justify-center mb-8 group-hover:bg-brand-gold group-hover:text-brand-darkBlue transition-colors">
                                    {i === 0 && <ShieldCheck size={28} className="text-brand-gold group-hover:text-brand-darkBlue" />}
                                    {i === 1 && <Clock size={28} className="text-brand-gold group-hover:text-brand-darkBlue" />}
                                    {i === 2 && <TrendingUp size={28} className="text-brand-gold group-hover:text-brand-darkBlue" />}
                                </div>
                                <h4 className="text-xl font-black text-brand-darkBlue mb-4 uppercase tracking-tighter group-hover:text-brand-gold transition-colors">{benefit.title}</h4>
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
                    <div className="mb-20">
                        <SectionTitle
                            ...
                            title="Métricas que <span class='text-brand-gold italic underline decoration-brand-gold/10 underline-offset-[12px]'>Mudam o Jogo</span>"
                            alignment="center"
                        />
                    </div>
                        ...
                        {SOCIAL_MEDIA_CONTENT.proof.metrics.map((m, i) => (
                            <div key={i} className="relative group p-8 rounded-[2rem] hover:bg-white hover:shadow-xl transition-all border border-transparent hover:border-slate-100 text-center">
                                <div className="flex flex-col items-center gap-2 mb-4">
                                    ...
                                    <span className="text-xs font-black text-brand-gold uppercase tracking-widest">{m.label}</span>
                                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                        {SOCIAL_MEDIA_CONTENT.proof.testimonials.map((t, i) => (
                            <div key={i} className="p-10 rounded-[3rem] bg-white border border-slate-100 shadow-xl relative hover:border-brand-gold/20 transition-all text-center md:text-left">
                                <Quote className="absolute top-8 right-8 text-brand-gold/10" size={48} />
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-black text-brand-gold uppercase tracking-widest">{t.role}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="py-32 bg-white overflow-hidden relative">
                <div className="absolute top-0 left-0 w-64 h-64 bg-brand-gold/5 rounded-full blur-[120px] pointer-events-none"></div>
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="mb-20">
                        <SectionTitle
                            badge="Diferenciais Elite"
                            title="Por que a <span class='text-brand-gold italic'>MD Solution?</span>"
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-24">
                        ...
                        <div className="flex-1 order-1 lg:order-2 space-y-12">
                            <div className="flex gap-8 group">
                                <div className="shrink-0 w-16 h-16 rounded-2xl bg-brand-gold text-brand-darkBlue flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                                    <Plus size={32} />
                                </div>
                                <div>
            ...
            <section className="py-24 lg:py-32 bg-slate-50 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
                    <SectionTitle
                        ...
                        title="Escolha sua <span class='text-brand-gold italic'>velocidade de escala</span>"
                            ...
                            <div
                                ...
                                className={`group relative rounded-[3rem] transition-all duration-700 flex flex-col h-full overflow-hidden
                                    ${plan.highlight
                                        ...
                                        : 'bg-white border border-slate-100 shadow-xl hover:border-brand-gold/30'
                                    }
                                `}
                            >
                                {plan.highlight && (
                                    <div className="bg-brand-gold text-brand-darkBlue py-2.5 text-center text-[9px] font-black uppercase tracking-[0.3em] flex items-center justify-center gap-2 italic">
                                ...
                                <div className="p-10 flex-grow flex flex-col">
                                    <div className="mb-6">
                                        ...
                                        <p className="text-brand-gold font-black text-[9px] uppercase tracking-[0.2em]">{plan.subtitle}</p>
                                    </div>
                                    ...
                                    <ul className="space-y-4 mb-10 flex-grow">
                                        {plan.features.slice(0, 10).map((feature, idx) => (
                                            <li key={idx} className="flex items-start gap-3">
                                                <div className={`w-4 h-4 rounded-full flex items-center justify-center shrink-0 mt-0.5 ${plan.highlight ? 'bg-brand-gold/20 text-brand-gold' : 'bg-brand-gold/10 text-brand-gold'}`}>
                                    ...
                                    <Button
                                        ...
                                        className={`h-14 text-[10px] font-black uppercase tracking-widest ${plan.highlight ? 'shadow-xl shadow-brand-gold/20' : 'border-slate-200 hover:bg-slate-900 hover:text-white hover:border-slate-900 group-hover:shadow-lg'}`}
                                    >
                    ...
                    <div className="max-w-5xl mx-auto pt-10 border-t border-slate-200/60">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                            {[
                                ...
                                <div key={i} className="bg-white/50 backdrop-blur-sm p-4 rounded-xl border border-slate-200/50 text-center hover:bg-white hover:border-brand-gold/30 transition-all hover:shadow-md cursor-default group">
                                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-wider mb-1 group-hover:text-brand-gold transition-colors">{addon.subtitle}</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {SOCIAL_MEDIA_CONTENT.mechanism.steps.map((step, i) => (
                            <div key={i} className="p-10 rounded-[2.5rem] bg-slate-50 border border-slate-100 text-center hover:bg-white hover:shadow-xl transition-all duration-500">
                                <div className="text-5xl font-black text-brand-gold/20 mb-6">{step.num}</div>
            ...
            <section id="contact" className="pt-24 lg:pt-40 pb-40 lg:pb-48 bg-brand-darkBlue relative overflow-hidden">
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-gold/20 rounded-full blur-[128px] pointer-events-none"></div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6 relative z-10 font-sans">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="w-full h-16 px-6 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:border-brand-gold focus:ring-1 focus:ring-brand-gold/50 transition-all text-slate-900 font-bold placeholder:text-slate-400"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <select
                                                ...
                                                onChange={handleChange}
                                                required
                                                title="Selecione o plano de interesse"
                                    ...
                                    <div className="pt-4 text-center">
                                        <Button
                                            type="submit"
                                            className="w-full h-20 text-lg font-black uppercase tracking-widest bg-brand-gold hover:bg-yellow-500 text-brand-darkBlue shadow-xl shadow-brand-gold/20 rounded-2xl"
                        ...
                        <div className="text-white text-left order-1 lg:order-2">
                            <SectionTitle
                                ...
                                title="Vamos <span class='text-brand-gold italic'>reposicionar</span> sua marca?"
                            ...
                            <div className="space-y-8 mt-12">
                                <div className="flex items-center gap-5 group">
                                    <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center text-brand-gold border border-white/10 group-hover:scale-110 transition-transform">
                                        <Megaphone size={28} />
                                    </div>
