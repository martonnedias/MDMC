...
import { MD_CONVERTE_PLANS } from '@/src/constants';
...
const MDConverteServicePage: React.FC = () => {
    ...
    const tabs = [
        { id: 'crm' as TabType, label: 'CRM de Vendas', icon: BarChart3, color: 'text-blue-600' },
        { id: 'agente' as TabType, label: 'Agente de Atendimento IA', icon: Bot, color: 'text-blue-600' },
        { id: 'conversoes' as TabType, label: 'Conversões', icon: TrendingUp, color: 'text-yellow-600' },
        { id: 'central' as TabType, label: 'Central de Atendimento', icon: Building2, color: 'text-blue-600' }
    ];
    ...
    return (
        <div className="pt-0 pb-0 font-sans">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="text-center lg:text-left">
                            <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-600 px-4 py-1.5 rounded-full mb-8 border border-blue-200 shadow-lg shadow-blue-500/5">
                            ...
                            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-heading font-black text-brand-darkBlue mb-12 tracking-tighter leading-[0.95] max-w-4xl">
                                Transforme <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-500 italic pr-1">leads</span> em clientes reais.
                            </h1>
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                                <Button onClick={scrollToContact} variant="primary" className="h-16 px-10 text-xs font-black uppercase tracking-widest shadow-2xl shadow-blue-600/20 hover:shadow-blue-600/40 transition-shadow bg-blue-600 hover:bg-blue-700">
                                    Agendar Demonstração
                                </Button>
                                <button className="h-16 px-8 flex items-center gap-3 text-brand-darkBlue hover:text-blue-600 transition-colors group font-black uppercase text-xs tracking-widest">
                            ...
                            <div className="mt-12 flex items-center justify-center lg:justify-start gap-4 text-xs font-bold text-slate-400 uppercase tracking-widest">
                                <span className="flex items-center gap-2"><CheckCircle2 size={14} className="text-blue-600" /> Implementação Rápida</span>
                                <span className="w-1 h-1 bg-slate-300 rounded-full"></span>
                                <span className="flex items-center gap-2"><CheckCircle2 size={14} className="text-blue-600" /> Suporte no Brasil</span>
                            </div>
                        </div>

                        {/* High-Fidelity Dashboard Mockup (Inspirado na Bolten) */}
                        <div className="relative group">
                            <div className="absolute inset-0 bg-gradient-to-tr from-blue-600/20 to-yellow-500/10 blur-[100px] rounded-full animate-pulse-slow"></div>

                            {/* Browser Frame */}
                            <div className="relative bg-slate-50 rounded-[2rem] border border-slate-200 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] overflow-hidden transition-all duration-700 ease-out hover:shadow-blue-500/10 h-[480px] flex flex-col">
                                ...
                                <div className="flex flex-1 overflow-hidden">
                                    ...
                                    <div className="w-48 bg-white border-r border-slate-100 hidden md:flex flex-col p-4 shrink-0">
                                        ...
                                        <div className="space-y-1">
                                            {[
                                                ...
                                                <div key={i} className={`flex items-center gap-2 px-3 py-2 rounded-xl transition-colors ${item.active ? 'bg-blue-50 text-blue-600' : 'text-slate-400 hover:bg-slate-50 hover:text-slate-600'}`}>
                                                    <item.icon size={16} />
                                    ...
                                    <div className="flex-1 bg-[#F8FAFC] p-6 overflow-hidden">
                                        ...
                                        <div className="grid grid-cols-5 gap-3 h-full">
                                            {[
                                                { label: 'Novos', color: 'bg-blue-500', amount: 'R$ 1.520', count: 12, leads: [{ name: 'Lead Premium', val: 'R$ 450' }] },
                                                { label: 'Contato', color: 'bg-yellow-500', amount: 'R$ 840', count: 4, leads: [{ name: 'Maria J.', val: 'R$ 390' }] },
                                                ...
                                                <div key={i} className="flex flex-col gap-3">
                                                    ...
                                                    {col.leads?.map((lead, j) => (
                                                        <div key={j} className={`bg-white p-3 rounded-xl border border-slate-200 shadow-sm animate-float [animation-delay:${i * 100}ms]`}>
                                                            <div className="text-[9px] font-black text-slate-800 mb-1">{lead.name}</div>
                                                            <div className="text-[8px] font-bold text-blue-600">{lead.val}</div>
                                                        </div>
                                                    ))}
                                                </div>
                                            ))}
            ...
            <section className="py-24 lg:py-32 bg-slate-50">
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <SectionTitle
                        ...
                        title="Tudo que você precisa para <span class='text-blue-600 italic'>vender mais</span>"
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-xl border border-slate-200">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[480px]">
                                <div className="flex flex-col justify-center h-full">
                                    <div className="flex items-center gap-4 mb-6">
                                        ...
                                        <h3 className="text-3xl lg:text-4xl font-heading font-black text-brand-darkBlue tracking-tighter leading-tight">CRM de vendas <span className="text-blue-600 italic">inteligente</span></h3>
                                    </div>
                                ...
                                <div className="relative group">
                                    <div className="absolute -inset-4 bg-gradient-to-br from-blue-500/10 to-blue-500/10 rounded-[3rem] blur-2xl group-hover:opacity-100 opacity-50 transition-opacity"></div>
                                                    ...
                                                    {[
                                                        ...
                                                        <div key={i} className="bg-white rounded-xl p-3 border border-slate-200 shadow-sm flex flex-col">
                                                            <div className="flex flex-col mb-3">
                                                                ...
                                                                <span className="text-[10px] font-black text-blue-600 leading-none">{stage.val}</span>
                                                            </div>
                                                            <div className="space-y-2 flex-1">
                                                                {stage.leads.map((lead, idx) => (
                                                                    <div key={idx} className="bg-slate-50 rounded-lg p-2 text-[8px] border border-slate-100 shadow-inner">
                                                                        ...
                                                                        <div className="text-blue-600 font-bold">{lead.v}</div>
                                                                    </div>
                                                                ))}
                                                            </div>
                                                        </div>
                        ...
                        {activeTab === 'agente' && (
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[480px]">
                                <div className="flex flex-col justify-center h-full">
                                    <div className="flex items-center gap-4 mb-6">
                                        <div className="w-14 h-14 bg-yellow-100 rounded-2xl flex items-center justify-center text-yellow-600 shrink-0 shadow-sm">
                                            <Bot size={28} />
                                        </div>
                                        <h3 className="text-3xl lg:text-4xl font-heading font-black text-brand-darkBlue tracking-tighter leading-tight">Agente de <span className="text-yellow-600 italic">atendimento IA</span></h3>
                                    </div>
                                    <p className="text-slate-600 text-lg mb-10 leading-relaxed font-medium">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6">
                                        {[
                                            ...
                                            <div key={i} className="flex items-center gap-3 group">
                                                <div className="w-6 h-6 rounded-full bg-yellow-100 flex items-center justify-center text-yellow-600 shrink-0 group-hover:bg-yellow-600 group-hover:text-white transition-colors">
                                                    <CheckCircle2 size={12} strokeWidth={3} />
                                                </div>
                                                <span className="text-sm font-bold text-slate-700 uppercase tracking-tight">{feature}</span>
                                            </div>
                                ...
                                <div className="relative group">
                                    <div className="absolute -inset-4 bg-gradient-to-br from-yellow-500/10 to-red-500/10 rounded-[3rem] blur-2xl group-hover:opacity-100 opacity-50 transition-opacity"></div>
                                    <div className="relative bg-slate-100 rounded-[2.5rem] p-4 border border-slate-200 shadow-2xl h-[420px] flex flex-col">
                                            ...
                                            <div className="p-6 flex-1 flex flex-col overflow-hidden gap-4">
                                                <div className="bg-slate-800/80 rounded-2xl p-4 border border-slate-700 self-start max-w-[80%] shadow-lg">
                                                    <div className="flex items-center gap-2 mb-3">
                                                        <div className="w-6 h-6 rounded-full bg-blue-500 flex items-center justify-center text-white text-[10px] font-black">AI</div>
                                                        <span className="text-[10px] text-slate-400 font-black uppercase tracking-widest">Agente Inteligente</span>
                                                    </div>
                                                    <div className="bg-yellow-500 text-white text-[11px] p-3 rounded-xl font-bold leading-relaxed">
                                            ...
                                            <div className="p-6 flex-1 flex flex-col overflow-hidden bg-slate-50/50">
                                                ...
                                                <div className="grid grid-cols-2 gap-4 flex-1">
                                                    <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm flex flex-col items-center justify-center">
                                                        <div className="w-20 h-20 mb-4 animate-pulse">
                                                            <svg viewBox="0 0 100 100">
                                                                ...
                                                                <circle cx="50" cy="50" r="40" fill="none" stroke="#F4B400" strokeWidth="12" strokeDasharray="70 251" strokeDashoffset="-180" />
                                                            </svg>
                                                        </div>
                                                        <div className="flex gap-4 text-[9px] font-black uppercase">
                                                            ...
                                                            <div className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-yellow-500"></div> Org.</div>
                                                        </div>
                                                    </div>
                                                    <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm flex flex-col justify-end gap-1 px-4">
                                                        ...
                                                        <div className="bg-brand-gold rounded-t h-[100%] shadow-lg shadow-yellow-500/20"></div>
                                                    ...
                                                    {['Pendente', 'Em Curso', 'Finalizado'].map((status, i) => (
                                                        <div key={i} className="bg-slate-800/50 rounded-xl p-3 border border-slate-700 flex flex-col">
                                                            <div className="flex items-center justify-between mb-3">
                                                                ...
                                                                <div className={`w-1 h-1 rounded-full ${i === 0 ? 'bg-yellow-500' : i === 1 ? 'bg-blue-500' : 'bg-emerald-500'}`}></div>
                                                            </div>
                                                            <div className="space-y-2 flex-1">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="mb-20">
                        <SectionTitle
                            ...
                            title="Por que usar o <span class='text-blue-600 italic'>CONVERTE Sim.?</span>"
                            alignment="center"
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={i} className="flex flex-col items-center text-center p-8 bg-slate-50 rounded-[2.5rem] hover:shadow-xl transition-all duration-300 group border border-transparent hover:border-blue-600/20">
                                <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mb-6 shadow-sm text-brand-darkBlue group-hover:text-blue-600 group-hover:scale-110 transition-all">
                                    <d.icon size={28} />
                                </div>
            ...
            <section className="py-24 lg:py-32 bg-slate-50">
                <div className="max-w-6xl mx-auto px-4 md:px-8">
                    <SectionTitle
                        ...
                        title="Planos que <span class='text-blue-600 italic'>se pagam</span>"
                        ...
                        {displayPlans.map((pkg, i) => (
                            <div
                                ...
                                className={`p-8 rounded-[2.5rem] border shadow-lg transition-all relative flex flex-col ${pkg.highlight
                                    ? 'bg-brand-darkBlue text-white border-blue-600 shadow-2xl z-10 md:-translate-y-6'
                                    : 'bg-white border-slate-200 hover:border-blue-600/30'
                                    }`}
                            >
                                {pkg.badge && (
                                    <div className={`absolute top-0 right-0 px-6 py-2 rounded-bl-3xl text-[10px] font-black uppercase tracking-[0.2em] shadow-lg ${pkg.highlight ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500'
                                        }`}>
                                        {pkg.badge}
                                    </div>
                                )}
                                ...
                                <p className={`text-xs font-bold uppercase tracking-wider mb-6 ${pkg.highlight ? 'text-blue-400' : 'text-slate-500'}`}>
                                    {pkg.subtitle}
                                </p>
                                ...
                                <ul className="space-y-4 mb-8 flex-1">
                                    {pkg.features.map((feat: string, j: number) => (
                                        <li key={j} className="flex gap-3 text-sm font-medium">
                                            <CheckIcon size={16} className={pkg.highlight ? 'text-blue-400' : 'text-blue-600'} />
                ...
                <div className="max-w-3xl mx-auto px-4 md:px-8">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={i} className="border border-slate-200 rounded-2xl overflow-hidden hover:border-blue-600/30 transition-colors">
                                <button
                                    onClick={() => toggleFaq(i)}
                                    className="w-full flex items-center justify-between p-6 text-left bg-white hover:bg-slate-50 transition-colors"
                                >
                                    <span className="font-bold text-brand-darkBlue text-lg pr-8">{faq.q}</span>
                                    {openFaqIndex === i ? <Minus size={20} className="text-blue-600 shrink-0" /> : <Plus size={20} className="text-slate-400 shrink-0" />}
                                </button>
                                {openFaqIndex === i && (
            ...
            <section id="contact-form" className="pt-24 lg:pt-40 pb-40 lg:pb-48 bg-brand-darkBlue relative overflow-hidden">
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-600/20 rounded-full blur-[128px] pointer-events-none"></div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="w-full h-16 px-6 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600/50 transition-all text-slate-900 font-bold placeholder:text-slate-400"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <select
                                                ...
                                                onChange={handleChange}
                                                required
                                                title="Selecione o tamanho da equipe"
                                                className="w-full h-16 px-6 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:border-brand-gold focus:ring-1 focus:ring-brand-gold/10 transition-all text-slate-500 font-bold cursor-pointer appearance-none"
                                            >
                                    ...
                                    <div className="pt-4 text-center">
                                        <Button
                                            type="submit"
                                            className="w-full h-20 text-lg font-black uppercase tracking-widest bg-blue-600 hover:bg-blue-700 shadow-xl shadow-blue-600/20 rounded-2xl"
                        ...
                        <div className="text-white text-left order-1 lg:order-2">
                            <SectionTitle
                                ...
                                title="Vamos <span class='text-blue-400 italic'>integrar</span> sua equipe?"
                            ...
                            <div className="space-y-8 mt-12">
                                <div className="flex items-center gap-5 group">
                                    <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center text-blue-400 border border-white/10 group-hover:scale-110 transition-transform">
