...
import { PLANS, ADS_FAQ, ADS_TESTIMONIALS, ADS_CONTENT } from '@/src/constants';
    ...
    <div className="pt-0 pb-0 font-sans">
      ...
      <section className="relative pt-44 lg:pt-60 pb-20 lg:pb-40 overflow-hidden bg-slate-950 text-white">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-40">
          ...
          <div className="absolute top-[20%] -right-[5%] w-[30%] h-[30%] bg-brand-gold/20 rounded-full blur-[100px] animate-pulse delay-700"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="flex-[1.2]">
              <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-md text-brand-gold px-4 py-1.5 rounded-full mb-8 font-black text-[9px] uppercase tracking-[0.2em] border border-white/10 shadow-xl">
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-heading font-black leading-[0.95] tracking-tighter mb-12 max-w-4xl text-white"
                dangerouslySetInnerHTML={{
                  __html: section?.title || 'Sua empresa <span class="text-transparent bg-clip-text bg-gradient-to-r from-brand-gold to-yellow-400 italic pr-1">invisível</span>? Ninguém compra de quem não vê.'
                }}
              />

              <p className="text-lg md:text-xl lg:text-2xl text-blue-100/90 mb-12 leading-relaxed font-bold max-w-2xl border-l-4 border-brand-gold/30 pl-8 transition-all">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-8 mb-16">
                <Button onClick={scrollToContact} variant="primary" className="h-16 px-10 text-xs font-black uppercase tracking-widest shadow-2xl shadow-brand-gold/20">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="text-left border-l border-white/10 pl-6">
                    <div className="flex gap-0.5 mb-1">
                      {[1, 2, 3, 4, 5].map(s => <Sparkles key={s} size={10} className="text-brand-gold fill-brand-gold" />)}
                    </div>
            ...
            <div className="flex-1 hidden lg:block">
              <div className="relative group p-4 bg-white/5 rounded-[3rem] border border-white/10 backdrop-blur-sm shadow-2xl rotate-3">
                <div className="absolute -inset-1 bg-gradient-to-br from-brand-gold to-brand-blue opacity-20 blur-xl"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mt-20">
            <div>
              <div className="space-y-12 mt-12">
                ...
                <div className="flex gap-8 group">
                  <div className="w-14 h-14 bg-white shadow-xl text-brand-gold rounded-2xl flex items-center justify-center shrink-0 font-black text-xl group-hover:scale-110 transition-transform duration-500">02</div>
                  <div>
            ...
            <div className="relative">
              <div className="bg-brand-darkBlue rounded-[3rem] p-12 text-white shadow-3xl relative z-10 overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-12">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center text-brand-gold border border-white/20">
                      <BarChart3 size={28} />
                    </div>
                    <div>
                ...
                <div className="space-y-8">
                  <div className="bg-slate-900/50 backdrop-blur-md rounded-3xl p-8 border border-white/5 group hover:border-brand-gold/30 transition-all duration-500">
              ...
              <div className="absolute -bottom-10 -left-10 w-full h-full border-2 border-brand-gold/20 rounded-[3.5rem] -z-10 translate-x-4 translate-y-4"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 lg:py-40 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <SectionTitle
            ...
            title="Mais que anúncios: <span class='text-brand-gold italic'>inteligência de vendas</span>"
      ...
      <section className="py-24 lg:py-40 bg-brand-darkBlue relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          <SectionTitle
            badge="Prova real"
            title="Quem domina o jogo <span class='text-brand-gold italic pr-1'>recomenda</span>"
              ...
              <div key={i} className="bg-white/5 backdrop-blur-md p-10 md:p-14 rounded-[3.5rem] border border-white/10 hover:bg-white/10 transition-all duration-700 group relative overflow-hidden">
                ...
                <div className="flex items-center gap-6 mb-10">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-brand-gold font-black uppercase tracking-[0.2em]">{t.role}</p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch max-w-7xl mx-auto mt-20">
            {displayPlans.map((plan, index) => (
              ...
              >
                {plan.highlight && (
                  <div className="bg-brand-gold text-brand-darkBlue py-3 text-center text-[10px] font-black uppercase tracking-[0.2em]">
                ...
                <div className="p-12 flex-grow flex flex-col">
                  ...
                  <p className="text-brand-gold font-bold text-[10px] uppercase tracking-[0.2em] mb-10">{plan.subtitle}</p>
                  ...
                  <ul className="space-y-6 mb-12 flex-grow">
                    {plan.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start gap-4">
                        <div className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5 ${plan.highlight ? 'bg-brand-gold/20 text-brand-gold' : 'bg-brand-blue/10 text-brand-blue'}`}>
                  ...
                  <div className={`p-6 rounded-[2rem] mb-10 border ${plan.highlight ? 'bg-white/5 border-white/20' : 'bg-slate-50 border-slate-100'}`}>
                    <p className={`text-[10px] font-black uppercase text-center tracking-[0.1em] ${plan.highlight ? 'text-brand-gold' : 'text-slate-500'}`}>Investimento Sugerido: {plan.adBudget}</p>
                  </div>

                  <Button
                    onClick={scrollToContact}
                    variant={plan.highlight ? 'primary' : 'outline'}
                    className={`h-16 text-xs font-black uppercase tracking-widest ${plan.highlight ? 'shadow-2xl shadow-brand-gold/40' : 'border-slate-200 hover:border-brand-blue hover:text-brand-blue'}`}
                  >
            ...
            {ADS_FAQ.map((faq, i) => (
              <div key={i} className="bg-slate-50 rounded-3xl border border-slate-100 overflow-hidden hover:border-brand-blue/20 transition-all duration-300">
                ...
                >
                  ...
                  <div className={`p-2 rounded-full bg-white shadow-sm transition-transform duration-300 ${openFaqIndex === i ? 'rotate-180 text-brand-gold' : 'text-slate-400'}`}>
                    <ChevronDown size={20} />
                  </div>
                </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        title="Escolha sua faixa de investimento"
                        className="w-full h-16 px-6 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:border-brand-gold focus:ring-1 focus:ring-brand-gold/50 transition-all text-slate-500 font-bold cursor-pointer appearance-none"
                      >
                  ...
                  <div className="pt-6">
                    <Button
                      ...
                      className="h-20 text-lg font-black uppercase tracking-widest bg-brand-gold hover:bg-yellow-500 text-brand-darkBlue shadow-xl shadow-brand-gold/20 rounded-2xl"
                    >
                      SOLICITAR PROPOSTA
                    </Button>
                  </div>
            ...
            <div className="text-white text-left order-1 lg:order-2">
              <SectionTitle
                ...
                title="Vamos <span class='text-brand-gold italic'>escalar</span> seu negócio?"
