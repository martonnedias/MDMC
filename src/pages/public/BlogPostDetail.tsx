...
import { adminService, BlogPost, BlogComment } from '@/src/services/adminService';
...
import { formatDateBR, formatRelativeTime } from '@/src/lib/dateUtils';
    ...
    if (!post) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
                ...
                <Button onClick={() => navigate('/blog')} variant="primary">Voltar para o Blog</Button>
            </div>
        );
    }
            ...
            <header className="relative h-[60vh] min-h-[400px] flex items-end pb-16 pt-24">
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    ...
                    <div className="max-w-4xl">
                        <span className="bg-brand-gold text-white text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-full mb-6 inline-block">
                            {post.category}
                        </span>
                        ...
                        <div className="flex flex-wrap items-center gap-6 text-sm text-white/60 font-medium">
                            <span className="flex items-center gap-2">
                                <Calendar size={18} className="text-brand-gold" /> {formatDateBR(post.created_at || '')}
                            </span>
                            <span className="flex items-center gap-2">
                                <UserIcon size={18} className="text-brand-gold" /> MD Solution Admin
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <main className="lg:col-span-8">
                        ...
                        <div className="mb-10 flex flex-wrap items-center gap-4 p-6 bg-gray-50 rounded-[2rem] border border-gray-100">
                            ...
                            <div className="flex flex-wrap gap-3">
                                ...
                                <a href={shareLinks.twitter} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-gray-900 text-white flex items-center justify-center hover:bg-brand-gold transition-all shadow-sm" title="X (Twitter)">
                                    <Twitter size={18} />
                                </a>
                            ...
                            {user ? (
                                ...
                                <div className="bg-blue-50/50 rounded-[2rem] p-10 border border-blue-100 text-center mb-12 animate-fade-in">
                                    ...
                                    <div className="flex flex-col items-center gap-4">
                                        <Button onClick={() => navigate('/acesso')} variant="primary" className="px-10">
                                            Fazer Login para Comentar
                                        </Button>
                                        <button
                                            onClick={() => navigate('/regras-comunidade')}
                                        ...
                                        <div className="flex gap-5">
                                            ...
                                            <div className="flex-grow">
                                                ...
                                                <button
                                                    ...
                                                    className="text-[10px] font-black uppercase text-brand-blue tracking-widest hover:text-brand-gold transition-colors"
                                                >
                                                    Responder
                                                </button>
                        ...
                        <div className="bg-gray-50 rounded-[2.5rem] p-8 border border-gray-100 sticky top-32">
                            ...
                            <div className="flex gap-4">
                                <button
                                    ...
                                    className="w-12 h-12 rounded-2xl bg-white border border-gray-100 flex items-center justify-center text-brand-blue hover:bg-brand-blue hover:text-white transition-all shadow-sm"
                                >
                                    <Share2 size={20} />
                                </button>
                                <button
                            ...
                            <div className="mt-12 bg-brand-darkBlue rounded-3xl p-8 text-center text-white relative overflow-hidden group">
                                ...
                                <Button
                                    onClick={() => navigate('/marketing-diagnosis')}
                                    variant="primary"
                                    fullWidth
                            ...
                            <div className="mt-12">
                                ...
                                <div className="space-y-6">
                                    {popularPosts.map((pPost, index) => (
                                        <div
                                            key={pPost.id}
                                            onClick={() => navigate(`/blog/${pPost.slug}`)}
                                            className="group cursor-pointer flex gap-4 items-start"
                                        >
                                            <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center text-xs font-black text-gray-300 group-hover:bg-brand-gold/10 group-hover:text-brand-gold transition-all duration-300 border border-gray-100">
                                                0{index + 1}
                                            </div>
                                            <div>
